...
public class SharedPrefManager {
    ...
    public boolean driverLogin(String driver_id, String driver_first_name, String driver_last_name, String driver_email, String driver_pic, String driver_contact){
