...
public class ScheduleFragment extends Fragment implements RetrofitListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        restHandler = new RestHandler(context, ScheduleFragment.this);

        recyclerView = view.findViewById(R.id.recycler_view_booking_schedule_fragment);
    ...
    private void getScheduleHistoryData() {
        pDialog.show();
        restHandler.makeHttpRequest(restHandler.retrofit.create(RestHandler.RestInterface.class).getBookingHistory(SharedPrefManager.getInstance(context).getDriverId(), "driver", "Scheduled"), "BookingHistory");
    }
